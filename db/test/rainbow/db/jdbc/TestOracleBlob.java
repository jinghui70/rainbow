...
public class TestOracleBlob {
	...
	public static void setUpBeforeClass() throws Exception {
		// dataSource = new SimpleDriverDataSource(new OracleDriver(),
		// "jdbc:oracle:thin:@10.14.132.179:1521:V3DB", "V3", "password");
	}
	...
	public void testByteArray() {
		...
		List<String> data = jdbcTemplate.queryForList("select NR from TEST_BLOB where id=1", new RowMapper<String>() {
			@Override
