...
/**
 * Represents a returned {@link java.sql.ResultSet} from a stored procedure
 * call.
 *
 * <p>
...
public class SqlReturnResultSet extends ResultSetSupportingSqlParameter {
	 ...
	 * @param extractor ResultSetExtractor to use for parsing the
	 ...
	 * 
	 * @param name    name of the parameter, as used in input and output maps
	 * @param handler RowCallbackHandler to use for parsing the
	 *                {@link java.sql.ResultSet}
	 */
